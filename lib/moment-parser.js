...
var MomentParser = Base.extend({
    ...
    parseAsMoment: function(source, options) {
        ...
        if (!moment._isAMomentObject) {
            throw new MomentParser.NotAMomentError("Not a moment");
        }
        return moment;
    },
    ...
    parseAsDuration: function(source, options) {
        ...
        if (duration._isAMomentObject) {
            throw new MomentParser.NotADurationError("Not a duration");
        }
        return duration;
    },
...
MomentParser.NotAMomentError = MomentGenerator.SyntaxError;
MomentParser.NotADurationError = MomentGenerator.SyntaxError;
